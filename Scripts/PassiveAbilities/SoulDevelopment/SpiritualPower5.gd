# res://Scripts/PassiveAbilities/SoulDevelopment/SpiritualPower5.gd
extends PassiveAbility

func _init():
	id = "spiritual_power_upgrade_5"
	name = "Духовная мощь V"
	description = "Увеличивает максимальную духовную духовную мощь на 5."
	rarity = "legendary"
...
func execute_ability(owner: Node, _target: Node = null, _context: Dictionary = {}) -> Dictionary:
	...
	return {
		"success": true,
		"message": "Духовная мощь увеличена на 5",
		"spiritual_power_bonus": 5
	}
